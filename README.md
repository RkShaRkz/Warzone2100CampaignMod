...
List of contents / pulled over things:
- gate
- heavy repair turret
- all 4 bastions/fortresses
- some multiplayer researches which were prerequisites for the pulled-over things
- maybe some of my own researches
- incendiary weapons - the incendiary mortar and howitzer
- twin assault cannon
- twin assault gun
- cyborg and vehicle armor-heat09 (as well as 07/08)

Weapon damages were (re)balanced to be in line with vanilla damages; this was done by finding the weapon's "family"/type,
looking at the siblings in the family, and then once a pattern emerges or is extrapolated, it is applied instead of raw mp.wz values

The so-called "rebalancing" has only to do with the super heavy bodies, so that they don't end up being cheaper than vengence/python.
